...
Visualizer.prototype={
	...
	start:function() {
		...
		fr.onload=function(e) {
			...
			audioContext.decodeAudioData(fileResult,function(buffer){that.visualize(audioContext,buffer);},function(e){console.log(e);});
		}
...
document.getElementById('header').onmouseover=function() {clearTimeout(s);};